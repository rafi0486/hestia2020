                    ...
                    <div class="modal-body" style="max-height: calc(100vh - 200px);overflow-y: auto;">
                        ...
                        <input type="hidden" id="evdd"  hidden/>
                            <div class="row" style='margin-bottom:10px;'>
                                <div class="col-md-12 col-sm-12" id="div_mail0"><input class="form-control" type="email" id="email0" placeholder="Email" value="<?php if(isset($_SESSION['email']))echo $_SESSION['email'];?>"; readonly></div>
                            </div>
