	...
	<div class="container">
		...
		<nav class="menu">
			...
			<ul class="menu__inner">
				...
				<li class="menu__item"><a class="menu__link" href="<?=base_url()?>contact">CONTACT</a></li>
			</ul>
		</nav>
		<div class="content" style="margin-top: 150px;">
			...
			<p align="justify">
				Hestia’19 is an extraordinary vision, inspired by a great purpose and
			...
			<p align="justify">
				The goal of Hestia’19 is to create the ultimate ensemble of
