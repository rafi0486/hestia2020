            ...
            <h3 class="box__title">
              <span class="box__title-inner"><?=$event->title?></span>
                  ...
                  <div class="overlay__content" style="margin-top:40vw;font-family: 'Montserrat', sans-serif;">
										...
										<?php if(count($this->docadmin_model->get_winners($event->event_id))>0 && $event->is_certificate_pub==1  ){ ?>
																		<?php $winners = $this->docadmin_model->get_winners($event->event_id);?>
																						<div class="result" style="border:4px solid black;padding:10px 0 0 0;margin-bottom:40px">

																									<span class="box__title-inner" style="font-size:34px;font-weight:600;padding-left:20px;margin:10px 0">Results</span>
																									<table class="table table-striped " style="margin-bottom:0">
																											<thead>
																												<tr>
																												<th scope="col" style="text-align:left">#</th>
																												<th scope="col" style="text-align:left">Name</th>
																												<th scope="col" style="text-align:left">College</th>
																												</tr>
																											</thead>
																											<tbody>
