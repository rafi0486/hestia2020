  ...
  <body class="demo-2">
    ...
    <main>
      ...
      <div style="position:absolute;top:35px;z-index:100;width:100%;">
        ...
        <div>
          <p
            class="hestia-font hestia-main content__subtitle"
          >
            HESTIA 20
          </p>
        </div>
        <div>
          <p
            ...
            style="text-align:center;letter-spacing:1px;font-size:14px; margin-top:3px;"
          >
            FEB 27 - MAR 01
          </p>
        </div>
      ...
      <div class="content">
        ...
        >
          ...
          <p
            style="margin-bottom:30px;margin-top:30px;letter-spacing:1px;"
            class="hestia-font content__subtitle"
          >
