...
<head>
  ...
  <meta name="description" content="About - <?=APP_META_CONTENT?>">
  ...
  <div class="container font-weight-bold">
    ...
    <div class="row pb-5" style="height:100vh">
      ...
      <div class="col-md-2 my-auto " style="text-align:center;">
        <img src="<?=base_url();?>assets/front/img/logo-tkmce.png" class="mx-4" style="max-width:95px;">

        <img src="<?=base_url();?>assets/front/img/logo.png" class="pb-3 mt-3 mx-4" style="max-width:120px;">
