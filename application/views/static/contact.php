...
<body class="demo-6" style="font-family: &#39;Montserrat&#39;, sans-serif;" data-gr-c-s-loaded="true">
	...
	<svg class="hidden">
		...
		<symbol id="icon-menu" viewBox="0 0 17.6 9.9">
			<title>menu</title>
			<path d="M17.6,1H0V0h17.6V1z M17.6,4.3h-12v1h12V4.3z M17.6,8.9h-6.9v1h6.9V8.9z"></path>
		</symbol>
	...
	<div class="container">
		...
		<nav class="Mobilemenu block-revealer">
			<div class="block-revealer__content" style="opacity: 0;">
				...
				<div class="text-white">
					<div class="row mb-4 pt-4">
						<div class="col-md-4 col-sm-12 person">
							<p class="name" style="font-weight: 500; letter-spacing: 1px; font-size: 1.2em; text-align: center; ">
								JOEL JOHN
							</p>
							<p class="text-center" style=" letter-spacing: 1px;  text-align: center; ">
								Arts Club Secretary<br />
								College Union<br />
								<a class="text-white" href="tel:+919745577594">+919745577594</a><br />
								<a class="text-white" href="mailto:joeljosephjohn@gmail.com">joeljosephjohn@gmail.com</a><br />
							</p>
						</div>
						<div class="col-md-4 col-sm-12 person">
							<p class="name" style="font-weight: 500; letter-spacing: 1px; font-size: 1.2em; text-align: center; ">
						...
						<div class="col-md-4 col-sm-12 person">
							...
							<p class="text-center" style=" letter-spacing: 1px;  text-align: center; ">
								...
								College Union<br />
								<a class="text-white" href="tel:+918592032761">+918592032761</a><br />
								<a class="text-white" href="mailto:azadrahulp@gmail.com">azadrahulp@gmail.com</a><br />
							</p>
						</div>
					</div>
					...
					<div class="row ">
						<div class="col-md-4 col-sm-12 person">
							...
							<p class="text-center" style=" letter-spacing: 1px;  text-align: center; ">
								Chairman<br />
								College Union<br />
								<a class="text-white" href="tel:+919207534855">+919207534855</a><br />
								<a class="text-white" href="mailto:ajmalnattingal@gmail.com">ajmalnattingal@gmail.com</a><br />
							</p>
						</div>
						<div class="col-md-4 col-sm-12 person">
							<p class="name" style="font-weight: 500; letter-spacing: 1px; font-size: 1.2em; text-align: center; ">
					...
					<div class="row mb-4 pt-2">
						...
						<div class="col-md-4 col-sm-12" style=" letter-spacing: 2px; padding-top:5%;">
							<p style="font-size: 2rem; text-align: center;">
								...
								<a href="mailto:info@hestialive.com" target="_blank"><i style="padding-left:10px;" class=" text-white fa fa-envelope"></i></a>
					...
					<div class="row">
						...
						<div class="col-md-4 col-sm-12" style=" letter-spacing: 2px;">
							<p style="font-weight: 600; font-size: .75em; text-align: center;">
								Web-related queries?
								<a class="text-white" href="mailto:webadmin@hestialive.com">webadmin@hestialive.com</a>
							</p>
						</div>
						<div class="col-md-4 col-sm-12"></div>
					</div>
