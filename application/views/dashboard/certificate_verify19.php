...
<div class="container">
    ...
    <div class="row" style="padding:10px;">
        ...
        <div class="col-md-3 col-sm-12" style="background: #fff;width:90%;border: grey; border-radius:5px; padding: 20px; position: absolute;top: 50%;left: 50%;transform: translateX(-50%) translateY(-50%);">
            <h4 style="margin-bottom:30px">Verify Certificate - Hestia'19</h4>
            <form id="team_form" action="<?=base_url("verify19")?>" method="post">
              <b><?=$msg;?></b>
...
<br>
                ...
                <button   type="button" class="btn btn-warning my-2 "  onclick="window.location='<?=base_url("verify")?>'" >Check Hestia'20</button><br>
